...
export const STEPS = [
  ...
  },
  {
    ...
    bullets: [
      '<b>Bandwidth</b> — how many bits per second fit. It is a hard ceiling, and storms move it in real time.',
      '<b>Latency</b> — how long a bit takes to arrive. You can always add more; you can almost never take it away.',
      '<b>Jitter</b> — the variance in that latency. This is what actually breaks playback, not raw delay.',
  ...
  },
  {
    ...
    bullets: [
      ...
      '<b>Interactive</b> (a call, a remote ROV): latency is the product. Keep buffers tiny, accept the gaps.',
      '<b>One-way observation</b> (a lighthouse feed): nobody is waiting for a reply. Buffer aggressively.',
  ...
  },
  {
    ...
    bullets: [
      ...
      '<b>Use it when</b> the link is one-way, the round trip is long, or loss is steady and bounded. <b>Skip it when</b> the link is clean and bandwidth is the binding constraint.',
    ],
    figure: figFEC,
  ...
  },
  {
    ...
    bullets: [
      ...
      'The right split is defined entirely by the consumer: a structural survey wants pixels, a collision detector wants frames.',
  ...
  },
  {
    ...
    bullets: [
      ...
      'This is not a video idea. It is snapshots versus event logs, base images versus layers, full sync versus deltas.',
    ],
    figure: figGop,
  ...
  },
  {
    ...
    bullets: [
      ...
      'Same pattern as a corrupted replication log or a broken CRDT merge — resync beats reconciliation.',
    ],
    figure: figSmear,
  ...
  },
  {
    ...
    bullets: [
      ...
      'Under sustained EMI, strong session integrity turns into a permanent reconnect loop — correct, and useless.',
  ...
  },
  {
    ...
    bullets: [
      ...
      'CBR is what you want on a <b>fixed, unshared, capacity-planned link</b>: it can never spike through the ceiling and take the tower offline.',
  ...
  },
  {
    ...
    bullets: [
      ...
      'A cheap <b>denoise or low-pass pre-filter</b> deletes that entropy before the encoder ever sees it — often halving bitrate with almost no loss of the signal you care about.',
